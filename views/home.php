    ...
    <section id="values" class="section values-section" aria-labelledby="values-title">
        <div class="container">
            <div class="section-title">
                ...
                <!-- MODIF: Rendu dynamique du titre et sous-titre avec $content['values'] et fallback -->
                <h2 id="values-title"><?php echo h(isset($content['values']['title']) ? $content['values']['title'] : 'Les Principes qui Nous Guident'); ?></h2>
                <p class="lead"><?php echo h(isset($content['values']['subtitle']) ? $content['values']['subtitle'] : 'Des valeurs fortes et authentiques qui définissent notre approche professionnelle et notre engagement envers nos clients'); ?></p>
            </div>
    ...
    <section id="news" class="section news-section" aria-labelledby="news-title">
        <div class="container">
            <div class="section-title">
                ...
                <!-- MODIF: Rendu dynamique du titre et sous-titre avec $content['news'] et fallback -->
    ...
    <section id="events" class="section news-section" aria-labelledby="events-title">
        <div class="container">
            <div class="section-title">
                ...
                <!-- MODIF: Rendu dynamique du titre et sous-titre avec $content['events'] et fallback -->
                <h2 id="events-title"><?php echo h(isset($content['events']['title']) ? $content['events']['title'] : 'Nos prochains événements'); ?></h2>
                <p class="lead"><?php echo h(isset($content['events']['subtitle']) ? $content['events']['subtitle'] : 'Rejoignez-nous pour nos conférences, ateliers et formations juridiques'); ?></p>
            </div>
            <div class="news-grid" role="region" aria-live="polite">
        ...
        <div class="container">
            <div class="max-w-4xl mx-auto">
                <div class="section-title">
                    ...
                    <!-- MODIF: Rendu dynamique du titre et sous-titre avec $content['contact'] et fallback -->
                    <h2 id="contact-title"><?php echo h(isset($content['contact']['title']) ? $content['contact']['title'] : 'Parlons de Votre Situation'); ?></h2>
                    <p class="lead"><?php echo h(isset($content['contact']['subtitle']) ? $content['contact']['subtitle'] : 'Bénéficiez d\'un premier échange gratuit pour évaluer vos besoins juridiques'); ?></p>
                </div>
    ...
    <footer class="footer" role="contentinfo">
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-section">
                    <h6>Contact</h6>
                    <!-- MODIF: Rendu dynamique des infos contact avec $content['contact'] et fallback -->
                    <p style="color: #d1d5db; margin: 0.5rem 0; display: flex; align-items: center; gap: 0.5rem;">
                        <i class="fas fa-map-marker-alt" aria-hidden="true"></i>
                        <span><?php echo nl2br(h($content['contact']['address'] ?? '123 Avenue des Champs-Élysées<br>75008 Paris, France')); ?></span>
                    </p>
                    <p style="color: #d1d5db; margin: 0.5rem 0; display: flex; align-items: center; gap: 0.5rem;">
            ...
            <div class="footer-bottom">
                <!-- MODIF: Rendu dynamique du copyright avec $content['footer']['copyright'] et fallback -->
                <p><?php echo h(isset($content['footer']['copyright']) ? $content['footer']['copyright'] : '© ' . date('Y') . ' ' . h(SITE_NAME) . '. Tous droits réservés.'); ?></p>
            </div>
        </div>
    </footer>
